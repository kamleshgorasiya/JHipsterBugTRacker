package make.sure.it.repository;

import make.sure.it.JhispterBugTrackerApp;
import make.sure.it.config.Constants;
import make.sure.it.config.audit.AuditEventConverter;
import make.sure.it.domain.PersistentAuditEvent;
...
import static make.sure.it.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
